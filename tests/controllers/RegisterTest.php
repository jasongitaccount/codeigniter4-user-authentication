...
use Citools\Auth\Controllers\AuthController;
...
class RegisterTest extends AuthTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $vConfig->ruleSets[] = \Citools\Auth\Authentication\Passwords\ValidationRules::class;
    ...
    public function testAttemptRegisterCreatesUserWithDefaultGroup()
    {
        ...
        $users = new \Citools\Auth\Models\UserModel();
