<?php namespace Citools\Auth\Authentication\Passwords;

use CodeIgniter\Entity;
use Citools\Auth\Exceptions\AuthException;
 ...
 *
 * @package Citools\Auth\Authentication\Passwords\Validators
 */
class NothingPersonalValidator extends BaseValidator implements ValidatorInterface
{
     ...
     * comes from Citools\Auth\Entities\User properties username and email. 
     * 
     ...
     * the `$personalFields` property in Citools\Auth\Config\Auth, e.g.
     * 
     ...
     * Similarity values equal to, or greater than Citools\Auth\Config::maxSimilarity 
