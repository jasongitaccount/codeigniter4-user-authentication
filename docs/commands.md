...
**Citools:Auth** provides a few command line tools to make managing users and groups easier.
...
script, or data stream. Users are added through `Citools\Auth\Models\UserModel` and thus are
